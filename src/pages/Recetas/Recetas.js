...
import { modificarPlatillo } from "../../api/platillo";
...
export default function Recetas() {
  ...
  const addComent = async () => {
    ...
    console.log("🚀 ~ file: Recetas.js ~ line 133 ~ addComent ~ recetaEspecifica", recetaEspecifica)
    const user = auth.data
    recetaEspecifica.comentarios.push({
    ...
    /* const response = await modificarPlatillo(
      recetaEspecifica._id,
      recetaEspecifica
    ); */
  };
  ...
  const commentsfooter = (
    <div className="addComentSection">
      <Row>
        <Col className="avatardiv" span={6}>
           <Avatar
            size={64}
            icon={<UserOutlined />}
          />
