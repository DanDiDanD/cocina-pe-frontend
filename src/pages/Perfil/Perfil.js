...
import { Row, Col, Button, PageHeader, Divider, Space, Table, Tabs, Image, Avatar, Input, notification, Modal as ModalAntd, List, Tag } from "antd";
                ...
                <Col lg={22}>
                  ...
                  {auth.data.is_premium ?
                    <List
                      loading={isLoading}
                      itemLayout="vertical"
                      dataSource={filterTableFavoritos == null ? baseDataFavoritos : filterTableFavoritos}
                      bordered={false}
                      pagination={{
                        onChange: (page) => { },
                        pageSize: 4,
                          ...
                          <List.Item.Meta
                            ...
                            description={item.descripcion ?
                              <div className="lista-favoritos-descripcion">
                                <div>
                                  {item.descripcion.substr(0, 200).concat(item.descripcion.length > 200 ? "..." : "")}
                                </div>
                                <div className="lista-favoritos-autor">
                                  <b>Autor: </b>{item.nombre_usuario}
                                </div>
                              </div>
                              : ""}
                          />
              ...
              <Row>
                ...
                <Col lg={22}>
                  ...
                  <List
                    loading={isLoading}
                    itemLayout="vertical"
                    dataSource={filterTableMisRecetas == null ? baseDataMisRecetas : filterTableMisRecetas}
                    bordered={false}
                    pagination={{
                      onChange: (page) => { },
                      pageSize: 4,
                    ...
                    renderItem={(item) => (
                      <List.Item
                        className="lista-favoritos"
                        actions={[
                            <Button className="boton-favoritos-ver-receta"
                              shape="round"
                              type="dashed"
                              icon={<EyeOutlined />}
                              href={`/cocina/recetas/${item._id}`}
                          ...
                          ,
                            <Button className="boton-favoritos-editar-receta"
                              shape="round"
                              type="dashed"
                              icon={<EditOutlined />}
                          ...
                          ,
                            <Button className="boton-favoritos-eliminar-receta"
                              shape="round"
                              type="danger"
                              icon={<DeleteOutlined />}
                              onClick={() => eliminarReceta(item._id, item.nombre)}
                            >
                              Eliminar
                            </Button>
                        ]}
